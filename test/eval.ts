...
function unitChecks(): Row[] {
  ...
  sec("reject percent-encoded backslash path traversal", () => normalizePath("/servers/%2e%2e%5c%2e%2e%5cadmin"), true);
  sec("reject malformed percent encoding", () => normalizePath("/servers/%invalid"), true);
