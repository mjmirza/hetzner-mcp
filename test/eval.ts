...
function unitChecks(): Row[] {
  ...
  sec("reject percent-encoded dots", () => normalizePath("/servers/%2e%2e/admin"), true);
  sec("reject uppercase percent-encoded dots", () => normalizePath("/servers/%2E%2E/admin"), true);
  sec("reject backslash path", () => normalizePath("/servers\\..\\admin"), true);
  sec("reject percent-encoded backslash", () => normalizePath("/servers/%5c%2e%2e/admin"), true);
  sec("reject malformed percent encoding", () => normalizePath("/servers/%xyz"), true);
