...
async function main(): Promise<void> {
  ...
  assert("security: reject percent-encoded dot traversal (lowercase)", encTravOk1);
  ...
  assert("security: reject percent-encoded dot traversal (uppercase)", encTravOk2);
